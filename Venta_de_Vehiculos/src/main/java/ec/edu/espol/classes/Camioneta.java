...
public class Camioneta extends Vehiculo{
    ...
    public Camioneta(String placa, String marca, String modelo, String tipomotor, int año, double recorrido, String color, String tipoCombustible, double precio, String vidrio, String transmision, String traccion,Vendedor dueño)
    {
        super(placa, marca, modelo, tipomotor, año, recorrido, color, tipoCombustible, precio,dueño); 
        this.vidrio = vidrio;
