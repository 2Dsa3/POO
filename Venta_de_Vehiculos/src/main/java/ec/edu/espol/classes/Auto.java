...
public class Auto extends Vehiculo{
    ...
    public Auto(String placa, String marca, String modelo, String tipoMotor,int año, double recorrido, String color, String tipoCombustible, double precio, String vidrio, String transmision,Vendedor dueño)

    {
        super(placa, modelo, marca, tipoMotor,año, recorrido, color, tipoCombustible, precio, dueño);
        this.vidrio = vidrio;
